...
const app = new App([ new BaseRoute(), new CartsRoutes(), new ProductsRoutes(), new FsCartsRoutes(), new FsProductsRoutes(), new ProductsViewsRoutes(), new CartsViewsRoutes() ]);
